<template>
    <div>
        <div class="text-center">
            <h1>Nest News Portal Example</h1>
            <p> This is the description of the news portal built with Nest.js, Vue.js and MongoDB</p>
...
export default {
  ...
  methods: {
    fetchPosts() {
      axios
        .get(`${server.baseURL}/news/posts`)
        .then(data => (this.posts = data.data));
    },
    deletePost(id) {
      axios.delete(`${server.baseURL}/news/delete?postID=${id}`).then(data => {
        console.log(data);
